...
export const HOST = 'https://shop.dev.minko.aexol.work/admin-api';
...
export const Thunder =
  ...
  <Z extends ValueTypes[R]>(
    ...
    return fn(
      ...
      return data;
    }) as Promise<InputType<GraphQLTypes[R], Z, UnionOverrideKeys<OVERRIDESCLR, SCLR>>>;
  };
...
type ZEUS_UNIONS =
  | GraphQLTypes['CreateAssetResult']
  | GraphQLTypes['NativeAuthenticationResult']
  | GraphQLTypes['AuthenticationResult']
  | GraphQLTypes['CreateChannelResult']
  | GraphQLTypes['UpdateChannelResult']
  | GraphQLTypes['CreateCustomerResult']
  | GraphQLTypes['UpdateCustomerResult']
  | GraphQLTypes['RemoveFacetFromChannelResult']
  | GraphQLTypes['UpdateGlobalSettingsResult']
  | GraphQLTypes['TransitionOrderToStateResult']
  | GraphQLTypes['SettlePaymentResult']
  | GraphQLTypes['CancelPaymentResult']
  | GraphQLTypes['AddFulfillmentToOrderResult']
  | GraphQLTypes['CancelOrderResult']
  | GraphQLTypes['RefundOrderResult']
  | GraphQLTypes['SettleRefundResult']
  | GraphQLTypes['TransitionFulfillmentToStateResult']
  | GraphQLTypes['TransitionPaymentToStateResult']
  | GraphQLTypes['ModifyOrderResult']
  | GraphQLTypes['AddManualPaymentToOrderResult']
  | GraphQLTypes['SetCustomerForDraftOrderResult']
  | GraphQLTypes['RemoveOptionGroupFromProductResult']
  | GraphQLTypes['CreatePromotionResult']
  | GraphQLTypes['UpdatePromotionResult']
  | GraphQLTypes['StockMovementItem']
...
export type ValueTypes = {
  ['Query']: AliasType<{
    administrators?: [
      { options?: ValueTypes['AdministratorListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['AdministratorList'],
    ];
    administrator?: [{ id: string | Variable<any, string> }, ValueTypes['Administrator']];
    activeAdministrator?: ValueTypes['Administrator'];
    assets?: [
      { options?: ValueTypes['AssetListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['AssetList'],
    ];
    asset?: [{ id: string | Variable<any, string> }, ValueTypes['Asset']];
    me?: ValueTypes['CurrentUser'];
    channels?: [
      { options?: ValueTypes['ChannelListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['ChannelList'],
    ];
    ...
    previewCollectionVariants?: [
      {
        input: ValueTypes['PreviewCollectionVariantsInput'] | Variable<any, string>;
        options?: ValueTypes['ProductVariantListOptions'] | undefined | null | Variable<any, string>;
      },
      ValueTypes['ProductVariantList'],
    ];
    countries?: [
      { options?: ValueTypes['CountryListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['CountryList'],
    ];
    country?: [{ id: string | Variable<any, string> }, ValueTypes['Country']];
    customerGroups?: [
      { options?: ValueTypes['CustomerGroupListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['CustomerGroupList'],
    ];
    ...
    jobs?: [
      { options?: ValueTypes['JobListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['JobList'],
    ];
    jobsById?: [{ jobIds: Array<string> | Variable<any, string> }, ValueTypes['Job']];
    jobQueues?: ValueTypes['JobQueue'];
    jobBufferSize?: [
      { bufferIds?: Array<string> | undefined | null | Variable<any, string> },
      ValueTypes['JobBufferSize'],
    ];
    ...
    eligibleShippingMethodsForDraftOrder?: [
      ...
      ValueTypes['ShippingMethodQuote'],
    ];
    paymentMethods?: [
      { options?: ValueTypes['PaymentMethodListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['PaymentMethodList'],
    ];
    ...
    productOptionGroups?: [
      { filterTerm?: string | undefined | null | Variable<any, string> },
    ...
    promotions?: [
      { options?: ValueTypes['PromotionListOptions'] | undefined | null | Variable<any, string> },
    ...
    provinces?: [
      { options?: ValueTypes['ProvinceListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['ProvinceList'],
    ];
    province?: [{ id: string | Variable<any, string> }, ValueTypes['Province']];
    roles?: [
      { options?: ValueTypes['RoleListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['RoleList'],
    ];
    role?: [{ id: string | Variable<any, string> }, ValueTypes['Role']];
    sellers?: [
      { options?: ValueTypes['SellerListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['SellerList'],
    ];
    seller?: [{ id: string | Variable<any, string> }, ValueTypes['Seller']];
    shippingMethods?: [
      { options?: ValueTypes['ShippingMethodListOptions'] | undefined | null | Variable<any, string> },
    ...
    testShippingMethod?: [
      { input: ValueTypes['TestShippingMethodInput'] | Variable<any, string> },
      ValueTypes['TestShippingMethodResult'],
    ];
    testEligibleShippingMethods?: [
      { input: ValueTypes['TestEligibleShippingMethodsInput'] | Variable<any, string> },
      ValueTypes['ShippingMethodQuote'],
    ];
    stockLocation?: [{ id: string | Variable<any, string> }, ValueTypes['StockLocation']];
    stockLocations?: [
      { options?: ValueTypes['StockLocationListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['StockLocationList'],
    ];
    tag?: [{ id: string | Variable<any, string> }, ValueTypes['Tag']];
    tags?: [
      { options?: ValueTypes['TagListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['TagList'],
    ];
    taxCategories?: [
      { options?: ValueTypes['TaxCategoryListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['TaxCategoryList'],
    ];
    taxCategory?: [{ id: string | Variable<any, string> }, ValueTypes['TaxCategory']];
    taxRates?: [
      { options?: ValueTypes['TaxRateListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['TaxRateList'],
    ];
    taxRate?: [{ id: string | Variable<any, string> }, ValueTypes['TaxRate']];
    zones?: [
      { options?: ValueTypes['ZoneListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['ZoneList'],
    ];
    zone?: [{ id: string | Variable<any, string> }, ValueTypes['Zone']];
    metricSummary?: [
      { input?: ValueTypes['MetricSummaryInput'] | undefined | null | Variable<any, string> },
      ValueTypes['MetricSummary'],
    ];
    page?: [{ id: string | Variable<any, string> }, ValueTypes['Page']];
    pages?: [
      { options?: ValueTypes['PageListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['PageList'],
    ];
    announcementBar?: [{ id: string | Variable<any, string> }, ValueTypes['AnnouncementBar']];
    announcementBars?: [
      { options?: ValueTypes['AnnouncementBarListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['AnnouncementBarList'],
    ];
    getActiveAnnouncementBar?: ValueTypes['AnnouncementBar'];
    wishlist?: [{ id: string | Variable<any, string> }, ValueTypes['Wishlist']];
    wishlists?: [
      { options?: ValueTypes['WishlistListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['WishlistList'],
    ];
    mostWishedProducts?: [
      { options?: ValueTypes['ProductListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['ProductList'],
    ...
    newsletterSubscribers?: [
      { options?: ValueTypes['NewsletterSubscriberListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['NewsletterSubscriberList'],
    ];
    backInStockSubscribers?: [
      { options?: ValueTypes['BackInStockSubscriberListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['BackInStockSubscriberList'],
    ];
    b2bSubscribers?: [
      { options?: ValueTypes['B2BSubscriberListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['B2BSubscriberList'],
    ];
    ...
    models?: [
      { options?: ValueTypes['ModelListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['ModelList'],
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ['Mutation']: AliasType<{
    createAdministrator?: [
      { input: ValueTypes['CreateAdministratorInput'] | Variable<any, string> },
      ValueTypes['Administrator'],
    ];
    updateAdministrator?: [
      { input: ValueTypes['UpdateAdministratorInput'] | Variable<any, string> },
      ValueTypes['Administrator'],
    ];
    updateActiveAdministrator?: [
      { input: ValueTypes['UpdateActiveAdministratorInput'] | Variable<any, string> },
      ValueTypes['Administrator'],
    ];
    ...
    assignRoleToAdministrator?: [
      { administratorId: string | Variable<any, string>; roleId: string | Variable<any, string> },
      ValueTypes['Administrator'],
    ];
    createAssets?: [
      { input: Array<ValueTypes['CreateAssetInput']> | Variable<any, string> },
      ValueTypes['CreateAssetResult'],
    ];
    ...
    assignAssetsToChannel?: [
      { input: ValueTypes['AssignAssetsToChannelInput'] | Variable<any, string> },
      ValueTypes['Asset'],
    ];
    login?: [
      {
    ...
    createChannel?: [
      { input: ValueTypes['CreateChannelInput'] | Variable<any, string> },
      ValueTypes['CreateChannelResult'],
    ];
    updateChannel?: [
      { input: ValueTypes['UpdateChannelInput'] | Variable<any, string> },
      ValueTypes['UpdateChannelResult'],
    ];
    ...
    createCollection?: [
      { input: ValueTypes['CreateCollectionInput'] | Variable<any, string> },
      ValueTypes['Collection'],
    ];
    updateCollection?: [
      { input: ValueTypes['UpdateCollectionInput'] | Variable<any, string> },
      ValueTypes['Collection'],
    ];
    ...
    assignCollectionsToChannel?: [
      { input: ValueTypes['AssignCollectionsToChannelInput'] | Variable<any, string> },
      ValueTypes['Collection'],
    ];
    removeCollectionsFromChannel?: [
      { input: ValueTypes['RemoveCollectionsFromChannelInput'] | Variable<any, string> },
      ValueTypes['Collection'],
    ];
    ...
    createCustomerGroup?: [
      { input: ValueTypes['CreateCustomerGroupInput'] | Variable<any, string> },
      ValueTypes['CustomerGroup'],
    ];
    updateCustomerGroup?: [
      { input: ValueTypes['UpdateCustomerGroupInput'] | Variable<any, string> },
      ValueTypes['CustomerGroup'],
    ];
    ...
    addCustomersToGroup?: [
      { customerGroupId: string | Variable<any, string>; customerIds: Array<string> | Variable<any, string> },
      ValueTypes['CustomerGroup'],
    ];
    ...
    createCustomer?: [
      ...
      ValueTypes['CreateCustomerResult'],
    ];
    updateCustomer?: [
      { input: ValueTypes['UpdateCustomerInput'] | Variable<any, string> },
      ValueTypes['UpdateCustomerResult'],
    ];
    ...
    createCustomerAddress?: [
      { customerId: string | Variable<any, string>; input: ValueTypes['CreateAddressInput'] | Variable<any, string> },
      ValueTypes['Address'],
    ];
    ...
    addNoteToCustomer?: [
      { input: ValueTypes['AddNoteToCustomerInput'] | Variable<any, string> },
      ValueTypes['Customer'],
    ];
    updateCustomerNote?: [
      { input: ValueTypes['UpdateCustomerNoteInput'] | Variable<any, string> },
    ...
    deleteFacet?: [
      { id: string | Variable<any, string>; force?: boolean | undefined | null | Variable<any, string> },
      ValueTypes['DeletionResponse'],
    ];
    deleteFacets?: [
      { ids: Array<string> | Variable<any, string>; force?: boolean | undefined | null | Variable<any, string> },
      ValueTypes['DeletionResponse'],
    ];
    createFacetValues?: [
      { input: Array<ValueTypes['CreateFacetValueInput']> | Variable<any, string> },
      ValueTypes['FacetValue'],
    ];
    updateFacetValues?: [
      { input: Array<ValueTypes['UpdateFacetValueInput']> | Variable<any, string> },
      ValueTypes['FacetValue'],
    ];
    deleteFacetValues?: [
      { ids: Array<string> | Variable<any, string>; force?: boolean | undefined | null | Variable<any, string> },
    ...
    assignFacetsToChannel?: [
      { input: ValueTypes['AssignFacetsToChannelInput'] | Variable<any, string> },
      ValueTypes['Facet'],
    ];
    removeFacetsFromChannel?: [
      { input: ValueTypes['RemoveFacetsFromChannelInput'] | Variable<any, string> },
      ValueTypes['RemoveFacetFromChannelResult'],
    ];
    updateGlobalSettings?: [
      { input: ValueTypes['UpdateGlobalSettingsInput'] | Variable<any, string> },
      ValueTypes['UpdateGlobalSettingsResult'],
    ];
    importProducts?: [{ csvFile: ValueTypes['Upload'] | Variable<any, string> }, ValueTypes['ImportInfo']];
    removeSettledJobs?: [
      {
        queueNames?: Array<string> | undefined | null | Variable<any, string>;
        olderThan?: ValueTypes['DateTime'] | undefined | null | Variable<any, string>;
      },
      boolean | `@${string}`,
    ];
    ...
    addFulfillmentToOrder?: [
      { input: ValueTypes['FulfillOrderInput'] | Variable<any, string> },
      ValueTypes['AddFulfillmentToOrderResult'],
    ];
    ...
    settleRefund?: [
      { input: ValueTypes['SettleRefundInput'] | Variable<any, string> },
      ValueTypes['SettleRefundResult'],
    ];
    addNoteToOrder?: [{ input: ValueTypes['AddNoteToOrderInput'] | Variable<any, string> }, ValueTypes['Order']];
    updateOrderNote?: [
      { input: ValueTypes['UpdateOrderNoteInput'] | Variable<any, string> },
      ValueTypes['HistoryEntry'],
    ];
    deleteOrderNote?: [{ id: string | Variable<any, string> }, ValueTypes['DeletionResponse']];
    transitionOrderToState?: [
      { id: string | Variable<any, string>; state: string | Variable<any, string> },
      ValueTypes['TransitionOrderToStateResult'],
    ];
    transitionFulfillmentToState?: [
      { id: string | Variable<any, string>; state: string | Variable<any, string> },
      ValueTypes['TransitionFulfillmentToStateResult'],
    ];
    transitionPaymentToState?: [
      { id: string | Variable<any, string>; state: string | Variable<any, string> },
      ValueTypes['TransitionPaymentToStateResult'],
    ];
    ...
    addManualPaymentToOrder?: [
      { input: ValueTypes['ManualPaymentInput'] | Variable<any, string> },
      ValueTypes['AddManualPaymentToOrderResult'],
    ];
    ...
    addItemToDraftOrder?: [
      {
        orderId: string | Variable<any, string>;
        input: ValueTypes['AddItemToDraftOrderInput'] | Variable<any, string>;
      },
    ...
    adjustDraftOrderLine?: [
      {
        orderId: string | Variable<any, string>;
        input: ValueTypes['AdjustDraftOrderLineInput'] | Variable<any, string>;
      },
      ValueTypes['UpdateOrderItemsResult'],
    ];
    removeDraftOrderLine?: [
      { orderId: string | Variable<any, string>; orderLineId: string | Variable<any, string> },
    ...
    setCustomerForDraftOrder?: [
      {
        ...
        input?: ValueTypes['CreateCustomerInput'] | undefined | null | Variable<any, string>;
      },
      ValueTypes['SetCustomerForDraftOrderResult'],
    ];
    setDraftOrderShippingAddress?: [
      { orderId: string | Variable<any, string>; input: ValueTypes['CreateAddressInput'] | Variable<any, string> },
      ValueTypes['Order'],
    ];
    ...
    setDraftOrderCustomFields?: [
      { orderId: string | Variable<any, string>; input: ValueTypes['UpdateOrderInput'] | Variable<any, string> },
      ValueTypes['Order'],
    ];
    applyCouponCodeToDraftOrder?: [
      { orderId: string | Variable<any, string>; couponCode: string | Variable<any, string> },
    ...
    setDraftOrderShippingMethod?: [
      { orderId: string | Variable<any, string>; shippingMethodId: string | Variable<any, string> },
      ValueTypes['SetOrderShippingMethodResult'],
    ];
    createPaymentMethod?: [
      { input: ValueTypes['CreatePaymentMethodInput'] | Variable<any, string> },
      ValueTypes['PaymentMethod'],
    ];
    updatePaymentMethod?: [
      { input: ValueTypes['UpdatePaymentMethodInput'] | Variable<any, string> },
      ValueTypes['PaymentMethod'],
    ];
    deletePaymentMethod?: [
      { id: string | Variable<any, string>; force?: boolean | undefined | null | Variable<any, string> },
    ...
    assignPaymentMethodsToChannel?: [
      { input: ValueTypes['AssignPaymentMethodsToChannelInput'] | Variable<any, string> },
      ValueTypes['PaymentMethod'],
    ];
    removePaymentMethodsFromChannel?: [
      { input: ValueTypes['RemovePaymentMethodsFromChannelInput'] | Variable<any, string> },
      ValueTypes['PaymentMethod'],
    ];
    createProductOptionGroup?: [
      { input: ValueTypes['CreateProductOptionGroupInput'] | Variable<any, string> },
      ValueTypes['ProductOptionGroup'],
    ];
    updateProductOptionGroup?: [
      { input: ValueTypes['UpdateProductOptionGroupInput'] | Variable<any, string> },
      ValueTypes['ProductOptionGroup'],
    ];
    createProductOption?: [
      { input: ValueTypes['CreateProductOptionInput'] | Variable<any, string> },
      ValueTypes['ProductOption'],
    ];
    updateProductOption?: [
      { input: ValueTypes['UpdateProductOptionInput'] | Variable<any, string> },
      ValueTypes['ProductOption'],
    ];
    ...
    updateProducts?: [
      { input: Array<ValueTypes['UpdateProductInput']> | Variable<any, string> },
      ValueTypes['Product'],
    ];
    ...
    addOptionGroupToProduct?: [
      { productId: string | Variable<any, string>; optionGroupId: string | Variable<any, string> },
      ValueTypes['Product'],
    ];
    removeOptionGroupFromProduct?: [
      ...
      ValueTypes['RemoveOptionGroupFromProductResult'],
    ];
    createProductVariants?: [
      { input: Array<ValueTypes['CreateProductVariantInput']> | Variable<any, string> },
      ValueTypes['ProductVariant'],
    ];
    updateProductVariants?: [
      { input: Array<ValueTypes['UpdateProductVariantInput']> | Variable<any, string> },
      ValueTypes['ProductVariant'],
    ];
    ...
    assignProductsToChannel?: [
      { input: ValueTypes['AssignProductsToChannelInput'] | Variable<any, string> },
      ValueTypes['Product'],
    ];
    removeProductsFromChannel?: [
      { input: ValueTypes['RemoveProductsFromChannelInput'] | Variable<any, string> },
      ValueTypes['Product'],
    ];
    assignProductVariantsToChannel?: [
      { input: ValueTypes['AssignProductVariantsToChannelInput'] | Variable<any, string> },
      ValueTypes['ProductVariant'],
    ];
    removeProductVariantsFromChannel?: [
      { input: ValueTypes['RemoveProductVariantsFromChannelInput'] | Variable<any, string> },
      ValueTypes['ProductVariant'],
    ];
    createPromotion?: [
      { input: ValueTypes['CreatePromotionInput'] | Variable<any, string> },
      ValueTypes['CreatePromotionResult'],
    ];
    updatePromotion?: [
      { input: ValueTypes['UpdatePromotionInput'] | Variable<any, string> },
      ValueTypes['UpdatePromotionResult'],
    ];
    ...
    assignPromotionsToChannel?: [
      { input: ValueTypes['AssignPromotionsToChannelInput'] | Variable<any, string> },
      ValueTypes['Promotion'],
    ];
    removePromotionsFromChannel?: [
      { input: ValueTypes['RemovePromotionsFromChannelInput'] | Variable<any, string> },
      ValueTypes['Promotion'],
    ];
    ...
    createShippingMethod?: [
      { input: ValueTypes['CreateShippingMethodInput'] | Variable<any, string> },
      ValueTypes['ShippingMethod'],
    ];
    updateShippingMethod?: [
      { input: ValueTypes['UpdateShippingMethodInput'] | Variable<any, string> },
      ValueTypes['ShippingMethod'],
    ];
    ...
    assignShippingMethodsToChannel?: [
      { input: ValueTypes['AssignShippingMethodsToChannelInput'] | Variable<any, string> },
      ValueTypes['ShippingMethod'],
    ];
    removeShippingMethodsFromChannel?: [
      { input: ValueTypes['RemoveShippingMethodsFromChannelInput'] | Variable<any, string> },
      ValueTypes['ShippingMethod'],
    ];
    createStockLocation?: [
      { input: ValueTypes['CreateStockLocationInput'] | Variable<any, string> },
      ValueTypes['StockLocation'],
    ];
    updateStockLocation?: [
      { input: ValueTypes['UpdateStockLocationInput'] | Variable<any, string> },
      ValueTypes['StockLocation'],
    ];
    deleteStockLocation?: [
      { input: ValueTypes['DeleteStockLocationInput'] | Variable<any, string> },
      ValueTypes['DeletionResponse'],
    ];
    deleteStockLocations?: [
      { input: Array<ValueTypes['DeleteStockLocationInput']> | Variable<any, string> },
      ValueTypes['DeletionResponse'],
    ];
    assignStockLocationsToChannel?: [
      { input: ValueTypes['AssignStockLocationsToChannelInput'] | Variable<any, string> },
      ValueTypes['StockLocation'],
    ];
    removeStockLocationsFromChannel?: [
      { input: ValueTypes['RemoveStockLocationsFromChannelInput'] | Variable<any, string> },
      ValueTypes['StockLocation'],
    ];
    ...
    createTaxCategory?: [
      { input: ValueTypes['CreateTaxCategoryInput'] | Variable<any, string> },
      ValueTypes['TaxCategory'],
    ];
    updateTaxCategory?: [
      { input: ValueTypes['UpdateTaxCategoryInput'] | Variable<any, string> },
      ValueTypes['TaxCategory'],
    ];
    ...
    addMembersToZone?: [
      { zoneId: string | Variable<any, string>; memberIds: Array<string> | Variable<any, string> },
      ValueTypes['Zone'],
    ];
    ...
    updateAnnouncementBar?: [
      { input: ValueTypes['UpdateAnnouncementBarInput'] | Variable<any, string> },
      ValueTypes['AnnouncementBar'],
    ];
    createAnnouncementBar?: [
      { input: ValueTypes['CreateAnnouncementBarInput'] | Variable<any, string> },
      ValueTypes['AnnouncementBar'],
    ];
    deleteAnnouncementBar?: [
      { input: ValueTypes['DeleteAnnouncementBarInput'] | Variable<any, string> },
      boolean | `@${string}`,
    ];
    changeStatusAnnouncementBar?: [
      { input: ValueTypes['ChangeStatusAnnouncementBarInput'] | Variable<any, string> },
      boolean | `@${string}`,
    ];
    registerRealization?: [
      { input: ValueTypes['OrderRealizationInput'] | Variable<any, string> },
      ValueTypes['OrderRealization'],
    ];
  ...
  ['CreateCollectionTranslationInput']: {
    ...
    customFields?:
      | ValueTypes['CreateCollectionTranslationInputCustomFields']
      | undefined
      | null
      | Variable<any, string>;
  };
  ['UpdateCollectionTranslationInput']: {
    ...
    customFields?:
      | ValueTypes['UpdateCollectionTranslationInputCustomFields']
      | undefined
      | null
      | Variable<any, string>;
  };
...
of the GlobalSettings */
  ...
  ['UpdateGlobalSettingsResult']: AliasType<{
    ['...on GlobalSettings']: ValueTypes['GlobalSettings'];
...
is not in the required state. */
  ...
  ['AddFulfillmentToOrderResult']: AliasType<{
    ['...on Fulfillment']: ValueTypes['Fulfillment'];
  ...
  ['ProductVariant']: AliasType<{
    ...
    stockMovements?: [
      { options?: ValueTypes['StockMovementListOptions'] | undefined | null | Variable<any, string> },
      ValueTypes['StockMovementList'],
    ];
    channels?: ValueTypes['Channel'];
    id?: boolean | `@${string}`;
...
If the `delete` flag is `true`, the price will be deleted for the given Channel. */
  ...
  ['CreatePromotionResult']: AliasType<{
    ['...on Promotion']: ValueTypes['Promotion'];
  ...
  ['StockMovementItem']: AliasType<{
    ['...on StockAdjustment']: ValueTypes['StockAdjustment'];
...
current session. */
  ...
  ['PaginatedList']: AliasType<{
    ...
    ['...on NewsletterSubscriberList']?: Omit<
      ValueTypes['NewsletterSubscriberList'],
      keyof ValueTypes['PaginatedList']
    >;
    ['...on BackInStockSubscriberList']?: Omit<
      ValueTypes['BackInStockSubscriberList'],
      keyof ValueTypes['PaginatedList']
    >;
  ...
  ['ErrorResult']: AliasType<{
    ...
    ['...on LanguageNotAvailableError']?: Omit<
      ValueTypes['LanguageNotAvailableError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on FacetInUseError']?: Omit<ValueTypes['FacetInUseError'], keyof ValueTypes['ErrorResult']>;
    ['...on ChannelDefaultLanguageError']?: Omit<
      ValueTypes['ChannelDefaultLanguageError'],
      keyof ValueTypes['ErrorResult']
    >;
    ...
    ['...on EmptyOrderLineSelectionError']?: Omit<
      ValueTypes['EmptyOrderLineSelectionError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on ItemsAlreadyFulfilledError']?: Omit<
      ValueTypes['ItemsAlreadyFulfilledError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on InvalidFulfillmentHandlerError']?: Omit<
      ValueTypes['InvalidFulfillmentHandlerError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on CreateFulfillmentError']?: Omit<ValueTypes['CreateFulfillmentError'], keyof ValueTypes['ErrorResult']>;
    ['...on InsufficientStockOnHandError']?: Omit<
      ValueTypes['InsufficientStockOnHandError'],
      keyof ValueTypes['ErrorResult']
    >;
    ...
    ['...on PaymentOrderMismatchError']?: Omit<
      ValueTypes['PaymentOrderMismatchError'],
      keyof ValueTypes['ErrorResult']
    >;
    ...
    ['...on RefundStateTransitionError']?: Omit<
      ValueTypes['RefundStateTransitionError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on PaymentStateTransitionError']?: Omit<
      ValueTypes['PaymentStateTransitionError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on FulfillmentStateTransitionError']?: Omit<
      ValueTypes['FulfillmentStateTransitionError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on OrderModificationStateError']?: Omit<
      ValueTypes['OrderModificationStateError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on NoChangesSpecifiedError']?: Omit<ValueTypes['NoChangesSpecifiedError'], keyof ValueTypes['ErrorResult']>;
    ['...on PaymentMethodMissingError']?: Omit<
      ValueTypes['PaymentMethodMissingError'],
      keyof ValueTypes['ErrorResult']
    >;
    ['...on RefundPaymentIdMissingError']?: Omit<
      ValueTypes['RefundPaymentIdMissingError'],
      keyof ValueTypes['ErrorResult']
    >;
...
`UpdateAddressInput` and `CreateAddressInput` to specify the country. */
  ...
  ['Page']: AliasType<{
    ...
    translations?: [
      { languageCode?: ValueTypes['LanguageCode'] | undefined | null | Variable<any, string> },
      ValueTypes['PageTranslation'],
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ...
  ['AnnouncementBarEntry']: AliasType<{
    ...
    translations?: [
      { languageCode?: ValueTypes['LanguageCode'] | undefined | null | Variable<any, string> },
      ValueTypes['AnnouncementBarEntryTranslation'],
    ];
    __typename?: boolean | `@${string}`;
  }>;
...
export type ResolverInputTypes = {
  ['Query']: AliasType<{
    administrators?: [
      { options?: ResolverInputTypes['AdministratorListOptions'] | undefined | null },
      ResolverInputTypes['AdministratorList'],
    ];
    ...
    channels?: [
      { options?: ResolverInputTypes['ChannelListOptions'] | undefined | null },
      ResolverInputTypes['ChannelList'],
    ];
    ...
    previewCollectionVariants?: [
      {
        input: ResolverInputTypes['PreviewCollectionVariantsInput'];
        options?: ResolverInputTypes['ProductVariantListOptions'] | undefined | null;
      },
      ResolverInputTypes['ProductVariantList'],
    ];
    countries?: [
      { options?: ResolverInputTypes['CountryListOptions'] | undefined | null },
      ResolverInputTypes['CountryList'],
    ];
    country?: [{ id: string }, ResolverInputTypes['Country']];
    customerGroups?: [
      { options?: ResolverInputTypes['CustomerGroupListOptions'] | undefined | null },
      ResolverInputTypes['CustomerGroupList'],
    ];
    ...
    paymentMethods?: [
      { options?: ResolverInputTypes['PaymentMethodListOptions'] | undefined | null },
      ResolverInputTypes['PaymentMethodList'],
    ];
    ...
    promotions?: [
      { options?: ResolverInputTypes['PromotionListOptions'] | undefined | null },
    ...
    provinces?: [
      { options?: ResolverInputTypes['ProvinceListOptions'] | undefined | null },
    ...
    sellers?: [
      { options?: ResolverInputTypes['SellerListOptions'] | undefined | null },
      ResolverInputTypes['SellerList'],
    ];
    seller?: [{ id: string }, ResolverInputTypes['Seller']];
    shippingMethods?: [
      { options?: ResolverInputTypes['ShippingMethodListOptions'] | undefined | null },
    ...
    testShippingMethod?: [
      { input: ResolverInputTypes['TestShippingMethodInput'] },
      ResolverInputTypes['TestShippingMethodResult'],
    ];
    testEligibleShippingMethods?: [
      { input: ResolverInputTypes['TestEligibleShippingMethodsInput'] },
      ResolverInputTypes['ShippingMethodQuote'],
    ];
    stockLocation?: [{ id: string }, ResolverInputTypes['StockLocation']];
    stockLocations?: [
      { options?: ResolverInputTypes['StockLocationListOptions'] | undefined | null },
      ResolverInputTypes['StockLocationList'],
    ];
    ...
    taxCategories?: [
      { options?: ResolverInputTypes['TaxCategoryListOptions'] | undefined | null },
      ResolverInputTypes['TaxCategoryList'],
    ];
    taxCategory?: [{ id: string }, ResolverInputTypes['TaxCategory']];
    taxRates?: [
      { options?: ResolverInputTypes['TaxRateListOptions'] | undefined | null },
    ...
    metricSummary?: [
      { input?: ResolverInputTypes['MetricSummaryInput'] | undefined | null },
      ResolverInputTypes['MetricSummary'],
    ];
    ...
    announcementBars?: [
      { options?: ResolverInputTypes['AnnouncementBarListOptions'] | undefined | null },
      ResolverInputTypes['AnnouncementBarList'],
    ];
    getActiveAnnouncementBar?: ResolverInputTypes['AnnouncementBar'];
    wishlist?: [{ id: string }, ResolverInputTypes['Wishlist']];
    wishlists?: [
      { options?: ResolverInputTypes['WishlistListOptions'] | undefined | null },
      ResolverInputTypes['WishlistList'],
    ];
    mostWishedProducts?: [
      { options?: ResolverInputTypes['ProductListOptions'] | undefined | null },
      ResolverInputTypes['ProductList'],
    ...
    newsletterSubscribers?: [
      { options?: ResolverInputTypes['NewsletterSubscriberListOptions'] | undefined | null },
      ResolverInputTypes['NewsletterSubscriberList'],
    ];
    backInStockSubscribers?: [
      { options?: ResolverInputTypes['BackInStockSubscriberListOptions'] | undefined | null },
      ResolverInputTypes['BackInStockSubscriberList'],
    ];
    b2bSubscribers?: [
      { options?: ResolverInputTypes['B2BSubscriberListOptions'] | undefined | null },
      ResolverInputTypes['B2BSubscriberList'],
    ];
    haveNotSeenNewsletterSubscribers?: boolean | `@${string}`;
    haveNotSeenBackInStockSubscribers?: boolean | `@${string}`;
    haveNotSeenB2BSubscribers?: boolean | `@${string}`;
  ...
  ['Mutation']: AliasType<{
    createAdministrator?: [
      { input: ResolverInputTypes['CreateAdministratorInput'] },
      ResolverInputTypes['Administrator'],
    ];
    updateAdministrator?: [
      { input: ResolverInputTypes['UpdateAdministratorInput'] },
      ResolverInputTypes['Administrator'],
    ];
    updateActiveAdministrator?: [
      { input: ResolverInputTypes['UpdateActiveAdministratorInput'] },
      ResolverInputTypes['Administrator'],
    ];
    ...
    assignCollectionsToChannel?: [
      { input: ResolverInputTypes['AssignCollectionsToChannelInput'] },
      ResolverInputTypes['Collection'],
    ];
    removeCollectionsFromChannel?: [
      { input: ResolverInputTypes['RemoveCollectionsFromChannelInput'] },
      ResolverInputTypes['Collection'],
    ];
    ...
    createCustomerGroup?: [
      { input: ResolverInputTypes['CreateCustomerGroupInput'] },
      ResolverInputTypes['CustomerGroup'],
    ];
    updateCustomerGroup?: [
      { input: ResolverInputTypes['UpdateCustomerGroupInput'] },
      ResolverInputTypes['CustomerGroup'],
    ];
    ...
    addCustomersToGroup?: [
      { customerGroupId: string; customerIds: Array<string> },
      ResolverInputTypes['CustomerGroup'],
    ];
    removeCustomersFromGroup?: [
      { customerGroupId: string; customerIds: Array<string> },
    ...
    createCustomer?: [
      { input: ResolverInputTypes['CreateCustomerInput']; password?: string | undefined | null },
      ResolverInputTypes['CreateCustomerResult'],
    ];
    ...
    createCustomerAddress?: [
      { customerId: string; input: ResolverInputTypes['CreateAddressInput'] },
    ...
    createFacetValues?: [
      { input: Array<ResolverInputTypes['CreateFacetValueInput']> },
      ResolverInputTypes['FacetValue'],
    ];
    updateFacetValues?: [
      { input: Array<ResolverInputTypes['UpdateFacetValueInput']> },
      ResolverInputTypes['FacetValue'],
    ];
    deleteFacetValues?: [
      { ids: Array<string>; force?: boolean | undefined | null },
      ResolverInputTypes['DeletionResponse'],
    ];
    assignFacetsToChannel?: [{ input: ResolverInputTypes['AssignFacetsToChannelInput'] }, ResolverInputTypes['Facet']];
    removeFacetsFromChannel?: [
      { input: ResolverInputTypes['RemoveFacetsFromChannelInput'] },
      ResolverInputTypes['RemoveFacetFromChannelResult'],
    ];
    updateGlobalSettings?: [
      { input: ResolverInputTypes['UpdateGlobalSettingsInput'] },
      ResolverInputTypes['UpdateGlobalSettingsResult'],
    ];
    importProducts?: [{ csvFile: ResolverInputTypes['Upload'] }, ResolverInputTypes['ImportInfo']];
    removeSettledJobs?: [
      { queueNames?: Array<string> | undefined | null; olderThan?: ResolverInputTypes['DateTime'] | undefined | null },
      boolean | `@${string}`,
    ];
    ...
    addFulfillmentToOrder?: [
      { input: ResolverInputTypes['FulfillOrderInput'] },
      ResolverInputTypes['AddFulfillmentToOrderResult'],
    ];
    ...
    transitionFulfillmentToState?: [
      ...
      ResolverInputTypes['TransitionFulfillmentToStateResult'],
    ];
    ...
    addManualPaymentToOrder?: [
      { input: ResolverInputTypes['ManualPaymentInput'] },
      ResolverInputTypes['AddManualPaymentToOrderResult'],
    ];
    /** Creates a draft Order */
    createDraftOrder?: ResolverInputTypes['Order'];
    deleteDraftOrder?: [{ orderId: string }, ResolverInputTypes['DeletionResponse']];
    addItemToDraftOrder?: [
      { orderId: string; input: ResolverInputTypes['AddItemToDraftOrderInput'] },
      ResolverInputTypes['UpdateOrderItemsResult'],
    ];
    adjustDraftOrderLine?: [
      { orderId: string; input: ResolverInputTypes['AdjustDraftOrderLineInput'] },
      ResolverInputTypes['UpdateOrderItemsResult'],
    ];
    ...
    setCustomerForDraftOrder?: [
      {
        ...
        input?: ResolverInputTypes['CreateCustomerInput'] | undefined | null;
      },
      ResolverInputTypes['SetCustomerForDraftOrderResult'],
    ];
    setDraftOrderShippingAddress?: [
      { orderId: string; input: ResolverInputTypes['CreateAddressInput'] },
    ...
    setDraftOrderCustomFields?: [
      { orderId: string; input: ResolverInputTypes['UpdateOrderInput'] },
      ResolverInputTypes['Order'],
    ];
    applyCouponCodeToDraftOrder?: [
      { orderId: string; couponCode: string },
    ...
    createPaymentMethod?: [
      { input: ResolverInputTypes['CreatePaymentMethodInput'] },
      ResolverInputTypes['PaymentMethod'],
    ];
    updatePaymentMethod?: [
      { input: ResolverInputTypes['UpdatePaymentMethodInput'] },
      ResolverInputTypes['PaymentMethod'],
    ];
    ...
    assignPaymentMethodsToChannel?: [
      { input: ResolverInputTypes['AssignPaymentMethodsToChannelInput'] },
      ResolverInputTypes['PaymentMethod'],
    ];
    removePaymentMethodsFromChannel?: [
      { input: ResolverInputTypes['RemovePaymentMethodsFromChannelInput'] },
      ResolverInputTypes['PaymentMethod'],
    ];
    createProductOptionGroup?: [
      { input: ResolverInputTypes['CreateProductOptionGroupInput'] },
      ResolverInputTypes['ProductOptionGroup'],
    ];
    updateProductOptionGroup?: [
      { input: ResolverInputTypes['UpdateProductOptionGroupInput'] },
      ResolverInputTypes['ProductOptionGroup'],
    ];
    createProductOption?: [
      { input: ResolverInputTypes['CreateProductOptionInput'] },
      ResolverInputTypes['ProductOption'],
    ];
    updateProductOption?: [
      { input: ResolverInputTypes['UpdateProductOptionInput'] },
      ResolverInputTypes['ProductOption'],
    ];
    ...
    removeOptionGroupFromProduct?: [
      { productId: string; optionGroupId: string; force?: boolean | undefined | null },
      ResolverInputTypes['RemoveOptionGroupFromProductResult'],
    ];
    createProductVariants?: [
      { input: Array<ResolverInputTypes['CreateProductVariantInput']> },
      ResolverInputTypes['ProductVariant'],
    ];
    updateProductVariants?: [
      { input: Array<ResolverInputTypes['UpdateProductVariantInput']> },
      ResolverInputTypes['ProductVariant'],
    ];
    ...
    assignProductsToChannel?: [
      { input: ResolverInputTypes['AssignProductsToChannelInput'] },
      ResolverInputTypes['Product'],
    ];
    removeProductsFromChannel?: [
      { input: ResolverInputTypes['RemoveProductsFromChannelInput'] },
      ResolverInputTypes['Product'],
    ];
    assignProductVariantsToChannel?: [
      { input: ResolverInputTypes['AssignProductVariantsToChannelInput'] },
      ResolverInputTypes['ProductVariant'],
    ];
    removeProductVariantsFromChannel?: [
      { input: ResolverInputTypes['RemoveProductVariantsFromChannelInput'] },
      ResolverInputTypes['ProductVariant'],
    ];
    createPromotion?: [
      { input: ResolverInputTypes['CreatePromotionInput'] },
      ResolverInputTypes['CreatePromotionResult'],
    ];
    updatePromotion?: [
      { input: ResolverInputTypes['UpdatePromotionInput'] },
      ResolverInputTypes['UpdatePromotionResult'],
    ];
    ...
    assignPromotionsToChannel?: [
      { input: ResolverInputTypes['AssignPromotionsToChannelInput'] },
      ResolverInputTypes['Promotion'],
    ];
    removePromotionsFromChannel?: [
      { input: ResolverInputTypes['RemovePromotionsFromChannelInput'] },
      ResolverInputTypes['Promotion'],
    ];
    ...
    createShippingMethod?: [
      { input: ResolverInputTypes['CreateShippingMethodInput'] },
      ResolverInputTypes['ShippingMethod'],
    ];
    updateShippingMethod?: [
      { input: ResolverInputTypes['UpdateShippingMethodInput'] },
      ResolverInputTypes['ShippingMethod'],
    ];
    ...
    assignShippingMethodsToChannel?: [
      { input: ResolverInputTypes['AssignShippingMethodsToChannelInput'] },
      ResolverInputTypes['ShippingMethod'],
    ];
    removeShippingMethodsFromChannel?: [
      { input: ResolverInputTypes['RemoveShippingMethodsFromChannelInput'] },
      ResolverInputTypes['ShippingMethod'],
    ];
    createStockLocation?: [
      { input: ResolverInputTypes['CreateStockLocationInput'] },
      ResolverInputTypes['StockLocation'],
    ];
    updateStockLocation?: [
      { input: ResolverInputTypes['UpdateStockLocationInput'] },
      ResolverInputTypes['StockLocation'],
    ];
    deleteStockLocation?: [
      { input: ResolverInputTypes['DeleteStockLocationInput'] },
      ResolverInputTypes['DeletionResponse'],
    ];
    deleteStockLocations?: [
      { input: Array<ResolverInputTypes['DeleteStockLocationInput']> },
      ResolverInputTypes['DeletionResponse'],
    ];
    assignStockLocationsToChannel?: [
      { input: ResolverInputTypes['AssignStockLocationsToChannelInput'] },
      ResolverInputTypes['StockLocation'],
    ];
    removeStockLocationsFromChannel?: [
      { input: ResolverInputTypes['RemoveStockLocationsFromChannelInput'] },
      ResolverInputTypes['StockLocation'],
    ];
    ...
    updateAnnouncementBar?: [
      { input: ResolverInputTypes['UpdateAnnouncementBarInput'] },
      ResolverInputTypes['AnnouncementBar'],
    ];
    createAnnouncementBar?: [
      { input: ResolverInputTypes['CreateAnnouncementBarInput'] },
      ResolverInputTypes['AnnouncementBar'],
    ];
    deleteAnnouncementBar?: [{ input: ResolverInputTypes['DeleteAnnouncementBarInput'] }, boolean | `@${string}`];
    changeStatusAnnouncementBar?: [
      { input: ResolverInputTypes['ChangeStatusAnnouncementBarInput'] },
      boolean | `@${string}`,
    ];
    registerRealization?: [
      { input: ResolverInputTypes['OrderRealizationInput'] },
      ResolverInputTypes['OrderRealization'],
    ];
...
is not in the required state. */
  ...
  ['ProductVariant']: AliasType<{
    ...
    stockMovements?: [
      { options?: ResolverInputTypes['StockMovementListOptions'] | undefined | null },
      ResolverInputTypes['StockMovementList'],
    ];
    channels?: ResolverInputTypes['Channel'];
    id?: boolean | `@${string}`;
...
current session. */
  ...
  ['Node']: AliasType<{
    ...
    ['...on BackInStockSubscriber']?: Omit<
      ResolverInputTypes['BackInStockSubscriber'],
  ...
  ['ErrorResult']: AliasType<{
    ...
    ['...on LanguageNotAvailableError']?: Omit<
      ResolverInputTypes['LanguageNotAvailableError'],
    ...
    ['...on ChannelDefaultLanguageError']?: Omit<
      ResolverInputTypes['ChannelDefaultLanguageError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on SettlePaymentError']?: Omit<
      ResolverInputTypes['SettlePaymentError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on CancelPaymentError']?: Omit<
      ResolverInputTypes['CancelPaymentError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on EmptyOrderLineSelectionError']?: Omit<
      ResolverInputTypes['EmptyOrderLineSelectionError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on ItemsAlreadyFulfilledError']?: Omit<
      ResolverInputTypes['ItemsAlreadyFulfilledError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on InvalidFulfillmentHandlerError']?: Omit<
      ResolverInputTypes['InvalidFulfillmentHandlerError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on CreateFulfillmentError']?: Omit<
      ResolverInputTypes['CreateFulfillmentError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on InsufficientStockOnHandError']?: Omit<
      ResolverInputTypes['InsufficientStockOnHandError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on MultipleOrderError']?: Omit<
      ResolverInputTypes['MultipleOrderError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on CancelActiveOrderError']?: Omit<
      ResolverInputTypes['CancelActiveOrderError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on PaymentOrderMismatchError']?: Omit<
      ResolverInputTypes['PaymentOrderMismatchError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on RefundOrderStateError']?: Omit<
      ResolverInputTypes['RefundOrderStateError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on NothingToRefundError']?: Omit<
      ResolverInputTypes['NothingToRefundError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on AlreadyRefundedError']?: Omit<
      ResolverInputTypes['AlreadyRefundedError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on QuantityTooGreatError']?: Omit<
      ResolverInputTypes['QuantityTooGreatError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on RefundStateTransitionError']?: Omit<
      ResolverInputTypes['RefundStateTransitionError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on PaymentStateTransitionError']?: Omit<
      ResolverInputTypes['PaymentStateTransitionError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on FulfillmentStateTransitionError']?: Omit<
      ResolverInputTypes['FulfillmentStateTransitionError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on OrderModificationStateError']?: Omit<
      ResolverInputTypes['OrderModificationStateError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on NoChangesSpecifiedError']?: Omit<
      ResolverInputTypes['NoChangesSpecifiedError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on PaymentMethodMissingError']?: Omit<
      ResolverInputTypes['PaymentMethodMissingError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on RefundPaymentIdMissingError']?: Omit<
      ResolverInputTypes['RefundPaymentIdMissingError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on ManualPaymentStateError']?: Omit<
      ResolverInputTypes['ManualPaymentStateError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on ProductOptionInUseError']?: Omit<
      ResolverInputTypes['ProductOptionInUseError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
    ['...on MissingConditionsError']?: Omit<
      ResolverInputTypes['MissingConditionsError'],
      keyof ResolverInputTypes['ErrorResult']
    >;
...
`UpdateAddressInput` and `CreateAddressInput` to specify the country. */
  ...
  ['Page']: AliasType<{
    ...
    translations?: [
      { languageCode?: ResolverInputTypes['LanguageCode'] | undefined | null },
      ResolverInputTypes['PageTranslation'],
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ['PageTranslation']: AliasType<{
  ...
  ['AnnouncementBarEntry']: AliasType<{
    ...
    translations?: [
      { languageCode?: ResolverInputTypes['LanguageCode'] | undefined | null },
      ResolverInputTypes['AnnouncementBarEntryTranslation'],
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ['AnnouncementBar']: AliasType<{
  ...
  ['Model']: AliasType<{
    ...
    translations?: [
      { languageCode?: ResolverInputTypes['LanguageCode'] | undefined | null },
      ResolverInputTypes['ModelTranslation'],
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ['ModelTranslation']: AliasType<{
...
is not in the required state. */
  ...
  ['SettlePaymentResult']:
    | ModelTypes['Payment']
    | ModelTypes['SettlePaymentError']
    | ModelTypes['PaymentStateTransitionError']
    | ModelTypes['OrderStateTransitionError'];
  ['CancelPaymentResult']:
    | ModelTypes['Payment']
    | ModelTypes['CancelPaymentError']
    | ModelTypes['PaymentStateTransitionError'];
  ['AddFulfillmentToOrderResult']:
    | ModelTypes['Fulfillment']
    | ModelTypes['EmptyOrderLineSelectionError']
    | ModelTypes['ItemsAlreadyFulfilledError']
    | ModelTypes['InsufficientStockOnHandError']
    | ModelTypes['InvalidFulfillmentHandlerError']
    | ModelTypes['FulfillmentStateTransitionError']
    | ModelTypes['CreateFulfillmentError'];
  ['CancelOrderResult']:
    | ModelTypes['Order']
    | ModelTypes['EmptyOrderLineSelectionError']
    | ModelTypes['QuantityTooGreatError']
    | ModelTypes['MultipleOrderError']
    | ModelTypes['CancelActiveOrderError']
    | ModelTypes['OrderStateTransitionError'];
  ['RefundOrderResult']:
    | ModelTypes['Refund']
    | ModelTypes['QuantityTooGreatError']
    | ModelTypes['NothingToRefundError']
    | ModelTypes['OrderStateTransitionError']
    | ModelTypes['MultipleOrderError']
    | ModelTypes['PaymentOrderMismatchError']
    | ModelTypes['RefundOrderStateError']
    | ModelTypes['AlreadyRefundedError']
    | ModelTypes['RefundStateTransitionError'];
  ...
  ['ModifyOrderResult']:
    | ModelTypes['Order']
    | ModelTypes['NoChangesSpecifiedError']
    | ModelTypes['OrderModificationStateError']
    | ModelTypes['PaymentMethodMissingError']
    | ModelTypes['RefundPaymentIdMissingError']
...
If the `delete` flag is `true`, the price will be deleted for the given Channel. */
  ...
  ['StockMovementType']: StockMovementType;
  ['StockMovement']:
    | ModelTypes['StockAdjustment']
    | ModelTypes['Allocation']
    | ModelTypes['Sale']
    | ModelTypes['Cancellation']
    | ModelTypes['Return']
    | ModelTypes['Release'];
  ['StockAdjustment']: {
    id: string;
...
current session. */
  ...
  ['Money']: any;
  ['PaginatedList']:
    | ModelTypes['AdministratorList']
    | ModelTypes['ChannelList']
    | ModelTypes['CustomerGroupList']
    | ModelTypes['JobList']
    | ModelTypes['PaymentMethodList']
    | ModelTypes['SellerList']
    | ModelTypes['StockLocationList']
    | ModelTypes['TaxCategoryList']
    | ModelTypes['ZoneList']
    ...
    | ModelTypes['PageList']
    | ModelTypes['AnnouncementBarList']
    | ModelTypes['WishlistList']
    | ModelTypes['NewsletterSubscriberList']
    | ModelTypes['BackInStockSubscriberList']
    | ModelTypes['B2BSubscriberList']
    | ModelTypes['ModelList'];
  ['Node']:
    | ModelTypes['Administrator']
    ...
    | ModelTypes['Fulfillment']
    | ModelTypes['Payment']
    | ModelTypes['OrderModification']
    | ModelTypes['Product']
    | ModelTypes['ProductVariant']
    | ModelTypes['StockLevel']
    | ModelTypes['StockLocation']
    | ModelTypes['StockAdjustment']
    | ModelTypes['Allocation']
    | ModelTypes['Sale']
    | ModelTypes['Cancellation']
    ...
    | ModelTypes['Zone']
    | ModelTypes['Page']
    | ModelTypes['AnnouncementBar']
    | ModelTypes['WishlistItem']
    | ModelTypes['Wishlist']
    | ModelTypes['NewsletterSubscriber']
    | ModelTypes['BackInStockSubscriber']
    | ModelTypes['B2BSubscriber']
    | ModelTypes['Model'];
  ['ErrorResult']:
    | ModelTypes['MimeTypeError']
    | ModelTypes['LanguageNotAvailableError']
    | ModelTypes['FacetInUseError']
    | ModelTypes['ChannelDefaultLanguageError']
    | ModelTypes['SettlePaymentError']
    | ModelTypes['CancelPaymentError']
    | ModelTypes['EmptyOrderLineSelectionError']
    | ModelTypes['ItemsAlreadyFulfilledError']
    ...
    | ModelTypes['PaymentMethodMissingError']
    | ModelTypes['RefundPaymentIdMissingError']
    | ModelTypes['ManualPaymentStateError']
    | ModelTypes['ProductOptionInUseError']
    | ModelTypes['MissingConditionsError']
    | ModelTypes['NativeAuthStrategyError']
    | ModelTypes['InvalidCredentialsError']
    | ModelTypes['OrderStateTransitionError']
